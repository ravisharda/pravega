...
public class AppendDecoder extends MessageToMessageDecoder<WireCommand> {
    ...
    public Request processCommand(WireCommand command) throws Exception {
        ...
        case APPEND_BLOCK:
            ...
            AppendDecoder.Segment sg = getSegment(currentBlock.getWriterId());
            result = null;
            break;
        case APPEND_BLOCK_END:
            ...
            currentBlock = null;
            result = new Append(segment.name, writerId, segment.lastEventNumber, blockEnd.numEvents, appendDataBuf,
                    null, blockEnd.getRequestId());
            break;
            //$CASES-OMITTED$
        default:
